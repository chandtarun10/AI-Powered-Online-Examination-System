...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span> Bhimtal, Uttrakhand, INDIA</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 9027239296 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> chandtarun1234@gmail.com</p>
    </div>
...
{echo'
      <form role="form" method="post" action="feed_submit.php?q=index.php">
...
function myMap() {
  // Coordinates for Graphic Era Hill University, Bhimtal Campus
  const officeLat = 29.3544;
  const officeLng = 79.5286;

  // Create the map with zoom and scroll enabled
  ...
  // Use a clean Google Maps-style light theme
  ...
  // Add marker
  const marker = L.marker([officeLat, officeLng], { icon: buildingIcon }).addTo(map);

  // Add popup with info
  marker.bindPopup(`
    <div style="text-align:center;">
      <h4 style="margin:0; color:#f4511e;">Graphic Era Hill University</h4>
      <p style="margin:0;">Bhimtal Campus, Uttarakhand, India</p>
      <a href="https://www.gehu.ac.in/" target="_blank" style="color:#007bff; text-decoration:none;">Visit Official Website</a>
    </div>
  `).openPopup();

  // Smooth zoom on scroll for better mobile UX
